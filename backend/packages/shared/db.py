...
# Deterministic constraint names (P1-2).  Without a convention, ORM-created
# constraints get Postgres-default names while migration-authored ones get
# manual names — every future ``alembic --autogenerate`` diff is noisy and
