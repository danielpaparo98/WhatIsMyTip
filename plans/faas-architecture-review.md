...
**Network Security:**
- `require-whisk-auth: false` on all functions in [`project.yml`](backend/project.yml:12) — DO Functions' built-in authentication is disabled. Security relies entirely on application-level checks.
